...
const TERMINAL_SEQUENCE = [
  ...
  { delay: 2000, type: "output", text: "", color: "text-slate-600 dark:text-slate-500" },
  { delay: 2100, type: "output", text: "  LocalFlux v1.0.0 — FOSS LAN Event Engine", color: "text-slate-600 dark:text-slate-400" },
  { delay: 2300, type: "output", text: "  ─────────────────────────────────────────", color: "text-slate-400 dark:text-slate-700" },
  { delay: 2500, type: "output", text: "  Starting LocalFlux State Machine...", color: "text-yellow-400" },
  { delay: 3200, type: "output", text: "  ✔  IndexedDB initialized", color: "text-emerald-600 dark:text-emerald-400" },
  { delay: 3600, type: "output", text: "  ✔  Zod schemas validated", color: "text-emerald-600 dark:text-emerald-400" },
  { delay: 4000, type: "output", text: "  ✔  Session state machine READY", color: "text-emerald-600 dark:text-emerald-400" },
  { delay: 4600, type: "output", text: "  ✔  Binding to 0.0.0.0:5173...", color: "text-emerald-600 dark:text-emerald-400" },
  { delay: 5200, type: "success", text: "  🚀 Engine running on http://192.168.1.5:5173", color: "text-emerald-700 dark:text-emerald-300" },
  { delay: 5800, type: "output", text: "", color: "text-slate-600 dark:text-slate-500" },
  { delay: 5900, type: "output", text: "  Host Dashboard → http://192.168.1.5:5173/host", color: "text-cyan-600 dark:text-cyan-400" },
  { delay: 6100, type: "output", text: "  Player Join   → http://192.168.1.5:5173/join", color: "text-cyan-600 dark:text-cyan-400" },
];
      ...
      <div className="relative z-10 container mx-auto px-6 py-32 md:py-40">
        ...
        >
          ...
          <motion.h1 
            ...
            className="text-5xl md:text-7xl font-bold text-slate-900 dark:text-white leading-tight transition-colors duration-300"
          >
          ...
          <motion.p 
            ...
            className="mt-6 text-lg text-slate-600 dark:text-gray-300 max-w-2xl mx-auto transition-colors duration-300"
          >
          ...
          <div className="mb-8 text-center flex flex-col gap-2 mt-12">
            <span className="font-mono text-xs tracking-[0.25em] text-slate-600 dark:text-slate-500 uppercase transition-colors duration-300">Developer Experience</span>
          ...
          >
            <div className="terminal-window relative">
              ...
              <div className="flex items-center gap-3 px-4 py-3 bg-slate-100 dark:bg-slate-800/60 border-b border-slate-300 dark:border-slate-700/60 transition-colors duration-300">
                ...
                <div className="flex-1 text-center">
                  <span className="font-mono text-xs text-slate-600 dark:text-slate-500 transition-colors duration-300">zsh — localflux</span>
                </div>
              ...
              >
                <div className="text-slate-500 dark:text-slate-700 text-xs mb-3 transition-colors duration-300">Last login: Mon Mar 24 07:31:18 on ttys001</div>

                <div className="flex items-center gap-2">
                  <span className="text-emerald-400">❯</span>
                  <span className="text-slate-700 dark:text-slate-300 transition-colors duration-300">{typingText}</span>
            ...
            <div className="mt-4 flex flex-wrap gap-4 justify-center">
              {[
                ...
                <div key={item.label} className="flex items-center gap-1.5 text-xs font-mono">
                  <span className="text-slate-600 dark:text-slate-500 transition-colors duration-300">{item.label}</span>
                  <span className="text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-slate-800/60 px-1.5 py-0.5 rounded border border-slate-300 dark:border-slate-700 transition-colors duration-300">{item.value}</span>
                </div>
              ))}
            </div>
          </motion.div>
